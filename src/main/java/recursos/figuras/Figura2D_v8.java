...
public abstract class Figura2D_v8 {
    private float ancho;
    private float alto;
    private String nombre;

    protected Figura2D_v8(float alto, float ancho, String nombre) {
        this.alto = alto;
        this.ancho = ancho;
        this.nombre = nombre;
    }

    protected Figura2D_v8(float altoYAncho, String nombre) {
        this.alto = altoYAncho;
        this.ancho = altoYAncho;
        this.nombre = nombre;
    }

    protected Figura2D_v8 (){
        this.alto = this.ancho = 0;
        this.nombre = null;
    }

    protected Figura2D_v8 (Figura2D_v8 fV7){
